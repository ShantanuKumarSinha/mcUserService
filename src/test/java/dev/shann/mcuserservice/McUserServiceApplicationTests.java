...
@TestPropertySource(locations = "file:../../../../resources/application-test.properties")
@ActiveProfiles("test")
class McUserServiceApplicationTests {
    ...
    @Test
    @SqlGroup({
            @Sql(scripts = "file:../../../../resources/test-data.sql", executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD)
    })
